...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      Users
      <span v-if="counts.users_total" class="nav-badge">{{ fmtCount(counts.users_total) }}</span>
    </NuxtLink>
    ...
    <NuxtLink
      ...
      Question Bank
      <span v-if="counts.questions_total" class="nav-badge">{{ fmtCount(counts.questions_total) }}</span>
    </NuxtLink>
