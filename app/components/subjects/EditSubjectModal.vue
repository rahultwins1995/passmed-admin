...
// A Subject (Clinical Area) is the top of the taxonomy — no parent. The Category
// picker that used to live here inverted the tree; sub-topics now declare their
// Subject from the Category manager instead.
...
const submitSave = async () => {
  ...
  try {
    const res:any = await $api.post('/subjects/update/'+props.detail.id, addform);
  ...
  <div class="drawer" style="width:400px;max-width:96vw">
    ...
    <div class="drawer-body">
      <div class="topwrapadd">
          ...
          <!-- No Category picker — a Subject is the top of the tree. -->
